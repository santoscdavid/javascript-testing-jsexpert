...
describe('CarService Suite Tests', () => {
  ...
  it('given carCategory, customer and  numberOfDays it should calculated final amount in real', () => {
  ...
  it('given a customer and a car category it should return a trasaction receipt', async () => {
    const car = mocks.validCar;
    const carCategory = {
